  ...
  return  isOpen?(
    <>
      ...
      <div className='absolute w-full h-full z-[60] top-0 left-0 overflow-auto ' >
        ...
        <div className={` backdrop-blur-md justify-self-center relative shadow-lg rounded-sm px-6 py-8 bg-zinc-100 dark:bg-zinc-800  ${width?width:'w-[90%] sm:w-[70%] md:w-[70%] xl:w-[50%]'} ${height?height:"h-auto max-h-[400px] top-1/4"}  overflow-x-hidden overflow-y-auto animate-[modal_0.2s_ease-in-out] mb-48 `} >
